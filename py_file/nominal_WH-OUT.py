...
dataset_CHAM_26_1['WH-OUT-NOMINAL'] = dataset_CHAM_26_1.apply(
    lambda x: x['WH-OUT'] / dataset_CHAM_26_1.loc[0, 'WH-OUT'], axis=1)
...
dataset_CHAM_26_2['WH-OUT-NOMINAL'] = dataset_CHAM_26_2.apply(
    lambda x: x['WH-OUT'] / dataset_CHAM_26_2.loc[0, 'WH-OUT'], axis=1)

line_CHAM_26_1 = go.Scatter(x=dataset_CHAM_26_1['Cycle'],
                            y=dataset_CHAM_26_1['WH-OUT-NOMINAL'],
                            name='CHAM_26_1',
                            marker_color='rgb(255,0,0)')

line_CHAM_26_2 = go.Scatter(x=dataset_CHAM_26_2['Cycle'],
                            y=dataset_CHAM_26_2['WH-OUT-NOMINAL'],
                            name='CHAM_26_2',
                            marker_color='rgb(255,0,0)',
                            line=dict(dash='dash'))
...
dataset_CHAM_32_1['WH-OUT-NOMINAL'] = dataset_CHAM_32_1.apply(
    lambda x: x['WH-OUT'] / dataset_CHAM_32_1.loc[0, 'WH-OUT'], axis=1)
...
dataset_CHAM_32_2['WH-OUT-NOMINAL'] = dataset_CHAM_32_2.apply(
    lambda x: x['WH-OUT'] / dataset_CHAM_32_2.loc[0, 'WH-OUT'], axis=1)

line_CHAM_32_1 = go.Scatter(x=dataset_CHAM_32_1['Cycle'],
                            y=dataset_CHAM_32_1['WH-OUT-NOMINAL'],
                            name='CHAM_32_1',
                            marker_color='rgb(0,255,0)')

line_CHAM_32_2 = go.Scatter(x=dataset_CHAM_32_2['Cycle'],
                            y=dataset_CHAM_32_2['WH-OUT-NOMINAL'],
                            name='CHAM_32_2',
                            marker_color='rgb(0,255,0)',
                            line=dict(dash='dash'))
...
dataset_MOLI_28_1['WH-OUT-NOMINAL'] = dataset_MOLI_28_1.apply(
    lambda x: x['WH-OUT'] / dataset_MOLI_28_1.loc[0, 'WH-OUT'], axis=1)
...
dataset_MOLI_28_2['WH-OUT-NOMINAL'] = dataset_MOLI_28_2.apply(
    lambda x: x['WH-OUT'] / dataset_MOLI_28_2.loc[0, 'WH-OUT'], axis=1)

line_MOLI_28_1 = go.Scatter(x=dataset_MOLI_28_1['Cycle'],
                            y=dataset_MOLI_28_1['WH-OUT-NOMINAL'],
                            name='MOLI_28_1',
                            marker_color='rgb(0,0,255)')

line_MOLI_28_2 = go.Scatter(x=dataset_MOLI_28_2['Cycle'],
                            y=dataset_MOLI_28_2['WH-OUT-NOMINAL'],
                            name='MOLI_28_2',
                            marker_color='rgb(0,0,255)',
                            line=dict(dash='dash'))
...
dataset_MOLI_42_1['WH-OUT-NOMINAL'] = dataset_MOLI_42_1.apply(
    lambda x: x['WH-OUT'] / dataset_MOLI_42_1.loc[0, 'WH-OUT'], axis=1)
...
dataset_MOLI_42_2['WH-OUT-NOMINAL'] = dataset_MOLI_42_2.apply(
    lambda x: x['WH-OUT'] / dataset_MOLI_42_2.loc[0, 'WH-OUT'], axis=1)

line_MOLI_42_1 = go.Scatter(x=dataset_MOLI_42_1['Cycle'],
                            y=dataset_MOLI_42_1['WH-OUT-NOMINAL'],
                            name='MOLI_42_1',
                            marker_color='rgb(255,0,255)')

line_MOLI_42_2 = go.Scatter(x=dataset_MOLI_42_2['Cycle'],
                            y=dataset_MOLI_42_2['WH-OUT-NOMINAL'],
                            name='MOLI_42_2',
                            marker_color='rgb(255,0,255)',
                            line=dict(dash='dash'))
...
fig.update_layout(
    title='Battery WH-OUT-NOMINAL/Cycle Data',
    xaxis_title='Cycle',
    yaxis_title='WH-OUT-NOMINAL',
    hovermode='x',
    yaxis_range = [0.65,1.05]
)
